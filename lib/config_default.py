...
# This currently only works with POW SHA256 and vCrypt Coins
# The available options are vcrypt and sha256d.
...
SOLUTION_BLOCK_HASH = True # If enabled, send the block hash. If false send the vcrypt hash in the shares table

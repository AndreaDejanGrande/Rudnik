...
class MiningSubscription(Subscription):
    ...
    def on_template(cls, is_new_block):
        ...
        (job_id, prevhash, coinb1, coinb2, doncoinb1, doncoinb2, merkle_branch, version, nbits, ntime, _) = \
            ...
            try:
                if subscription != None:
                    ...
                    if session['authorized'].keys():
                        ...
                        subscription.emit_single(work_id, prevhash, coinb1, coinb2, doncoinb1, doncoinb2, merkle_branch, version, nbits, ntime, clean_jobs)
                    else:
                        subscription.emit_single(job_id, prevhash, coinb1, coinb2, doncoinb1, doncoinb2, merkle_branch, version, nbits, ntime, clean_jobs)
    ...
    def _finish_after_subscribe(self, result):
        ...
        clean_jobs = True
        self.emit_single(job_id, prevhash, coinb1, coinb2, doncoinb1, doncoinb2, merkle_branch, version, nbits, ntime, True)

...
CENTRAL_WALLET = 'DJdVKiWnnXQsMmaFU1tVeZcT36VdwK8Ys1'                # Local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 9401
COINDAEMON_TRUSTED_USER = 'vdinarrpc'
...
# vcrypt, sha256d, vcrypt-jane, skeinhash, quark and riecoin
# If the option does not meet either of these criteria stratum defaults to vcrypt
# For Coins which support TX Messages please enter yes in the TX selection
COINDAEMON_ALGO = 'vcrypt'
COINDAEMON_TX = 'no'
...
STRATUM_MINING_PROCESS_NAME= 'vdinar-twistd-stratum-mining'
...
#### Advanced Option ##### 
# For backwards compatibility, we send the vcrypt hash to the solutions column in the shares table 
...
SOLUTION_BLOCK_HASH = True      # If enabled, enter the block hash. If false enter the vcrypt/sha hash into the shares table 

#Pass vcrypt hash to submit block check.
